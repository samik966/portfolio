const HomeImage = () => {
	return (
		<svg
			...
			></polygon>
			<path
				d='M189.89,128.63a8.12,8.12,0,0,0,4-2.49s-.09,4.14-4.55,8.32Z'
				fill='#ce8172'
				opacity='0.31'
			></path>
			<path
				d='M186.76,116.5s-1.4,6.76-.78,11.44a3.46,3.46,0,0,0,3.91,3c2.35-.34,5.43-1.49,6.62-5l2.75-5.75a6.2,6.2,0,0,0-1.94-6.9C193.78,110,187.4,112.34,186.76,116.5Z'
				fill='#f4a28c'
			></path>
			<path
				d='M186.1,120.8l-2.22,2.42a1.1,1.1,0,0,0,.48,1.8l2.57.81Z'
				fill='#f4a28c'
			></path>
			<path
			...
			></ellipse>
			<path
				d='M183.78,144.14s-40.92-11.82-40.73,17.9c.15,22.45,25.33,70.11,25.33,70.11h52s39.45-60.51,20.26-80S217.05,149.42,183.78,144.14Z'
				fill='rgba(var(--secondary-light), 1)'
			></path>
			<polygon
				points='168.3 239.43 199.94 247.96 228.01 233.72 232.27 226.12 203.98 226.12 158.97 226.12 168.3 239.43'
				fill='rgba(var(--secondary-dark), 1)'
			></polygon>
			<path
				d='M217.44,148.4S202.1,156.1,206.5,196c1.24,11.23-2.52,14-2.52,14l-43.85,4.39,8.25,17.75h52S243.2,195,245,175.87,217.44,148.4,217.44,148.4Z'
				opacity='0.08'
			></path>
			<path
			...
			></path>
			<path
				d='M193.28,237.56s-43-22-46.71-10.28,26,18.49,45.14,19.19Z'
				fill='rgba(var(--secondary-dark), 1)'
			></path>
			<path
				d='M203.73,239.29s34.33-34,41.37-24-19.14,25.51-37.17,32Z'
				fill='rgba(var(--secondary-dark), 1)'
			></path>
			<path
				d='M205.08,241.85s-10.17,9.06-4.28,11.73,7.13-6.29,7.13-6.29Z'
				fill='rgba(var(--secondary-light), 1)'
			></path>
			<path
			...
			></rect>
			<polygon
				points='172.73 220.85 169.06 187.43 225.18 187.43 219.58 222.56 220.38 227.06 172.14 227.44 172.73 220.85'
				fill='rgba(var(--secondary), 1)'
			></polygon>
			<path
